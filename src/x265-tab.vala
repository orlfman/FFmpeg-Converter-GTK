...
public class X265Tab : BaseCodecTab {
    ...
    private void apply_profile_format_requirements () {
        ...
        if (profile == "Main") {
            ...
            if (pixel_format_selector.ten_bit_check.active)
                pixel_format_selector.ten_bit_check.set_active (false);
            ...
            if (pixel_format_selector.eight_bit_check.active)
                pixel_format_selector.eight_bit_check.set_active (false);
            if (!pixel_format_selector.ten_bit_check.active)
                pixel_format_selector.ten_bit_check.set_active (true);
